                ...
                <div className={styles.nav}>
                    ...
                    <div className={styles.center}>
                        ...
                        <div className={styles.tabs}>
                            <button onClick={e => { setActiveNavTab(!activeNavTab) }} className={`${styles.tab} ${!activeNavTab ? styles.active : ""}`}>Chat</button>
                            <button onClick={e => { setActiveNavTab(!activeNavTab) }} className={`${styles.tab} ${activeNavTab ? styles.active : ""}`}>Friends</button>
                        </div>
